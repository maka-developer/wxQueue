...
class SendRequest
{
    ...
    public function synccheck()
    {
        ...
        $url = "https://webpush.".$data['host']."/cgi-bin/mmwebwx-bin/synccheck?skey=".urlencode($data['skey'])."&sid=".urlencode($data['wxsid'])."&uin=".$data['wxuin']."&deviceid=".$this->TrueRand."&synckey=".urlencode($data['syncKey']['List'])."&_=".time().rand(100,999);
        $queue = new RequestHandel($url);
