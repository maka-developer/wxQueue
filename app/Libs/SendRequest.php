...
class SendRequest
{
    ...
    public function synccheck()
    {
        ...
        $url = "https://webpush.".$data['host']."/cgi-bin/mmwebwx-bin/synccheck?r=".$this->TurnTime."&skey=".urlencode($data['skey'])."&sid=".$data['wxsid']."&uin=".$data['wxuin']."&deviceid=".$this->TrueRand."&synckey=".urlencode($data['syncKeyStr'])."&_=".time().rand(100,999);
        $queue = new RequestHandel($url);
